...
Deep_Sea_Exploration = Innovation_Card("Deep Sea Exploration", 4, "Exploration", "test", ["NaturalResourceUse", "Global Warming"])

exploration = [space_Exploration,Deep_Sea_Exploration]


self_Driving_Cars = Innovation_Card("Self Driving Cars", 5, "Travel", "test2", ["NaturalResourceUse", "Global Warming"])
